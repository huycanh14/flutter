...
const kBottomContianeColour = Color(0xFFEB1555);
...
const kResualTextStyle = TextStyle(color: Color(0xFF24D876), fontSize: 22.0, fontWeight: FontWeight.bold);
const kBIMTextStyle = TextStyle(fontSize: 100.0, fontWeight: FontWeight.bold);
